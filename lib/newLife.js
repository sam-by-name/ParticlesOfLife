...
//         // 2 partial 1 whole side below //
//         else if (tSr && !rS && bSr) cls = 'cellTrBrBr'
//         else if (rSb && !bS && lSb) cls = 'cellBrBlBr'
//         else if (bSl && !lS && tSl) cls = 'cellBlTlBr'
//         else if (lSt && !tS && rSt) cls = 'cellTlTrBr'
//         // 1 full side 1 partial //
//         else if ((!tS && rSt) || (tSr && !rS)) cls = 'cellTrBr'
//         else if ((!rS && bSr) || (rSb && !bS)) cls = 'cellBrBr'
//         else if ((!bS && lSb) || (bSl && !lS)) cls = 'cellBlBr'
//         else if ((!lS && tSl) || (lSt && !tS)) cls = 'cellTlBr'
//         // 2 partial sides below //
//         else if (tSr && rSt) cls = 'cellTrBr'
//         else if (rSb && bSr) cls = 'cellBrBr'
//         else if (bSl && lSb) cls = 'cellBlBr'
//         else if (lSt && tSl) cls = 'cellTlBr'
